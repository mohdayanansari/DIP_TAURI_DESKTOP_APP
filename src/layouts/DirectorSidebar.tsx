		...
		>
			<div>
				...
				<div className='flex items-center justify-center py-5 min-h-fit'>
					<h1 className='text-xl font-black text-center capitalize'>
...
const PATHS = [
	...
	{
		name: 'Reports',
		link: '/director/director-reports',
		icon: () => <MdSpaceDashboard />,
	},
	{
		name: 'Archive/Reports',
		link: '/director/director-history',
		icon: () => <MdArchive />,
	},
	{
		name: 'Setting',
		link: '/director/director-settings',
		icon: () => <AiFillSetting />,
	},
];
